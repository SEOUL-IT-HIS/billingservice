...
public interface BillingDetailService {
    ...
    BillingStatusDTO getBillingStatus(String billingDetailId);
    //status로 조회
    List<BillingDetailItemDTO> getVisitBillingPreview(String visitId);
    //방문id로 조회
    List<BillingDetailItemDTO> getAdmissionBillingPreview(String admissionId);
    //입퇴원id로 조회
}
